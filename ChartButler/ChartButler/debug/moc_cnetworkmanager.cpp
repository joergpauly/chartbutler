...
**
** Created: Tue 9. Oct 18:09:17 2012
...
int CNetworkManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dlDataReady(); break;
        case 1: dlFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void CNetworkManager::dlDataReady()
{
