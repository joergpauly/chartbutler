...
**
** Created: Sat 3. Nov 17:53:52 2012
...
void CDatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData CDatabaseManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CDatabaseManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CDatabaseManager,
      qt_meta_data_CDatabaseManager, &staticMetaObjectExtraData }
};
